...
tk.Button(main_screen, text="Start", width=20, height=3, bg="grey", font="19", command=mostimppart).place(x=145, y=559)
...
btn = Radiobutton(Numbers, text="0", font=1, variable=v, value=29, command=num0)
btn.place(x=0, y=0)
btn = Radiobutton(Numbers, text="1", font=1, variable=v, value=30, command=num1)
btn.place(x=0, y=25)
btn = Radiobutton(Numbers, text="2", font=1, variable=v, value=31, command=num2)
btn.place(x=50, y=0)
btn = Radiobutton(Numbers, text="3", font=1, variable=v, value=32, command=num3)
btn.place(x=50, y=25)
btn = Radiobutton(Numbers, text="4", font=1, variable=v, value=33, command=num4)
btn.place(x=98, y=0)
btn = Radiobutton(Numbers, text="5", font=1, variable=v, value=34, command=num5)
btn.place(x=98, y=25)
btn = Radiobutton(Numbers, text="6", font=1, variable=v, value=35, command=num6)
btn.place(x=148, y=0)
btn = Radiobutton(Numbers, text="7", font=1, variable=v, value=36, command=num7)
btn.place(x=148, y=25)
btn = Radiobutton(Numbers, text="8", font=1, variable=v, value=37, command=num8)
btn.place(x=198, y=0)
btn = Radiobutton(Numbers, text="9", font=1, variable=v, value=38, command=num9)
btn.place(x=198, y=25)

# Symbols
Symbols = ttk.Frame(tabs)
tabs.add(Symbols, text='Symbols')
btn = Radiobutton(Symbols, text="(", variable=v, value=39, command=sym1)
btn.place(x=0, y=0)
btn = Radiobutton(Symbols, text=")", variable=v, value=40, command=sym2)
btn.place(x=30, y=0)
btn = Radiobutton(Symbols, text="[", variable=v, value=41, command=sym3)
btn.place(x=63, y=0)
btn = Radiobutton(Symbols, text="]", variable=v, value=42, command=sym4)
btn.place(x=93, y=0)
btn = Radiobutton(Symbols, text="{", variable=v, value=43, command=sym5)
btn.place(x=123, y=0)
btn = Radiobutton(Symbols, text="}", variable=v, value=44, command=sym6)
btn.place(x=153, y=0)
btn = Radiobutton(Symbols, text="<", variable=v, value=45, command=sym7)
btn.place(x=183, y=0)
btn = Radiobutton(Symbols, text=">", variable=v, value=46, command=sym8)
btn.place(x=213, y=0)
btn = Radiobutton(Symbols, text="!", variable=v, value=47, command=sym9)
btn.place(x=243, y=0)
btn = Radiobutton(Symbols, text="@", variable=v, value=48, command=sym10)
btn.place(x=273, y=0)
btn = Radiobutton(Symbols, text="#", variable=v, value=49, command=sym11)
btn.place(x=310, y=0)
btn = Radiobutton(Symbols, text="$", variable=v, value=50, command=sym12)
btn.place(x=340, y=0)
btn = Radiobutton(Symbols, text="%", variable=v, value=51, command=sym13)
btn.place(x=370, y=0)
btn = Radiobutton(Symbols, text="^", variable=v, value=52, command=sym14)
btn.place(x=405, y=0)
btn = Radiobutton(Symbols, text="&", variable=v, value=53, command=sym15)
btn.place(x=0, y=25)
btn = Radiobutton(Symbols, text="*", variable=v, value=54, command=sym16)
btn.place(x=33, y=25)
btn = Radiobutton(Symbols, text="-", variable=v, value=55, command=sym17)
btn.place(x=63, y=25)
btn = Radiobutton(Symbols, text="_", variable=v, value=56, command=sym18)
btn.place(x=93, y=25)
btn = Radiobutton(Symbols, text="=", variable=v, value=57, command=sym19)
btn.place(x=123, y=25)
btn = Radiobutton(Symbols, text="+", variable=v, value=58, command=sym20)
btn.place(x=153, y=25)
btn = Radiobutton(Symbols, text=";", variable=v, value=59, command=sym21)
btn.place(x=183, y=25)
btn = Radiobutton(Symbols, text=":", variable=v, value=60, command=sym22)
btn.place(x=213, y=25)
btn = Radiobutton(Symbols, text="'", variable=v, value=61, command=sym23)
btn.place(x=243, y=25)
btn = Radiobutton(Symbols, text='"', variable=v, value=62, command=sym24)
btn.place(x=273, y=25)
btn = Radiobutton(Symbols, text="\\", variable=v, value=63, command=sym25)
btn.place(x=310, y=25)
btn = Radiobutton(Symbols, text="|", variable=v, value=64, command=sym26)
btn.place(x=340, y=25)
btn = Radiobutton(Symbols, text=",", variable=v, value=65, command=sym27)
btn.place(x=375, y=25)
btn = Radiobutton(Symbols, text=".", variable=v, value=66, command=sym28)
btn.place(x=405, y=25)
btn = Radiobutton(Symbols, text="/", variable=v, value=67, command=sym29)
btn.place(x=0, y=49)
btn = Radiobutton(Symbols, text="?", variable=v, value=68, command=sym30)
btn.place(x=30, y=49)
...
btn4 = Radiobutton(custom, text="Type Letter By Letter", variable=v, value=92, command=letterbyletter)
btn4.place(x=0,y=50)
btn4 = Radiobutton(custom, text="Type at once", variable=v, value=93, command=atonce)
...
btn = Radiobutton(other_keys, text="ESC", variable=v, value=69, command=esc)
btn.place(x=0, y=0)
btn = Radiobutton(other_keys, text="Tab", variable=v, value=70, command=tab)
btn.place(x=41, y=0)
btn = Radiobutton(other_keys, text="Windows Key", variable=v, value=71, command=winkey)
btn.place(x=83, y=0)
btn = Radiobutton(other_keys, text="Space", variable=v, value=72, command=space)
btn.place(x=177, y=0)
btn = Radiobutton(other_keys, text="Enter", variable=v, value=73, command=enter)
btn.place(x=231, y=0)
btn = Radiobutton(other_keys, text="Backspace", variable=v, value=74, command=backspace)
btn.place(x=283, y=0)
btn = Radiobutton(other_keys, text="Upwards arrow", variable=v, value=75, command=up)
btn.place(x=361, y=0)
btn = Radiobutton(other_keys, text="Downwards arrow", variable=v, value=76, command=down)
btn.place(x=0, y=25)
btn = Radiobutton(other_keys, text="Left arrow", variable=v, value=77, command=left)
btn.place(x=121, y=25)
btn = Radiobutton(other_keys, text="Right arrow", variable=v, value=78, command=right)
btn.place(x=198, y=25)
btn = Radiobutton(other_keys, text="Delete", variable=v, value=79, command=delete)
btn.place(x=285, y=25)
btn = Radiobutton(other_keys, text="F1", variable=v, value=80, command=f1)
btn.place(x=341, y=25)
btn = Radiobutton(other_keys, text="F2", variable=v, value=81, command=f2)
btn.place(x=378, y=25)
btn = Radiobutton(other_keys, text="F3", variable=v, value=82, command=f3)
btn.place(x=415, y=25)
btn = Radiobutton(other_keys, text="F4", variable=v, value=83, command=f4)
btn.place(x=0, y=50)
btn = Radiobutton(other_keys, text="F5", variable=v, value=84, command=f5)
btn.place(x=38, y=50)
btn = Radiobutton(other_keys, text='F6', variable=v, value=85, command=f6)
btn.place(x=75, y=50)
btn = Radiobutton(other_keys, text="F7", variable=v, value=86, command=f7)
btn.place(x=113, y=50)
btn = Radiobutton(other_keys, text="F8", variable=v, value=87, command=f8)
btn.place(x=148, y=50)
btn = Radiobutton(other_keys, text="F9", variable=v, value=88, command=f9)
btn.place(x=184, y=50)
btn = Radiobutton(other_keys, text="F10", variable=v, value=89, command=f10)
btn.place(x=219, y=50)
btn = Radiobutton(other_keys, text="F11", variable=v, value=90, command=f11)
